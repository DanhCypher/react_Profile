...
export const heroData: Hero = {
  ...
  actions: [
    {
      href: 'https://drive.google.com/file/d/1uc1fl_t_oCPQtWC71bqYPzYO4TQ1LwCG/view?usp=sharing',
      // fix this
      text: 'Resume',
      primary: true,
...
export const aboutData: About = {
  ...
  description: `I am a fourth-year student majoring in Software Engineering, passionate about designing and developing modern digital products. I possess a solid foundation in both Frontend and Backend development, along with strong self-learning abilities and the capacity to quickly adapt to new technologies.
...
export const education: TimelineItem[] = [
  {
    ...
    content: <p>GPA: 3.17/4.0</p>,
  },
];

export const experience: TimelineItem[] = [
  {
    date: '27/08/2025 - Now (Remote Support)',
  ...
  items: [
    {
      ...
      text: 'brucelee6788@gmail.com',
      href: 'mailto:brucelee6788@gmail.com',
    },
    {
      type: ContactType.Facebook,
      text: 'Lê Zanh',
      href: 'https://www.facebook.com/danhlowkey',
    },
    {
...
export const socialLinks: Social[] = [
  {label: 'Github', Icon: GithubIcon, href: 'https://github.com/DanhCypher'},
  {label: 'Facebook', Icon: FacebookIcon, href: 'https://www.facebook.com/danhlowkey'},
];
