        ...
        <ResumeSection title="Project">
          <ul className="list-disc pl-6">
            <li>
              ...
              <ul className="pl-6">
                <li>
                  <strong>Developer (group)</strong>
                </li>
                <li>
                  <strong>Objective:</strong> Develop an intelligent printing system for students and administrators.
                </li>
                <li>
                  <strong>Role:</strong> Built user interface and implemented features like login, printing, payments,
                  and printer management.
                </li>
                <li>
                  <strong>Tech Stack:</strong> Node.js, Express, MongoDB, HTML/CSS/JavaScript.
                </li>
                <li>
                  <strong>Achievements:</strong>
                  <ul className="pl-6">
                    <li>
                      Completed a fully functional printing system with login, print settings, history, and payment
                      features.
                    </li>
                ...
                <li>
                  ...
                  <a href="https://github.com/ThaiThiYenNhiBA/SSPS" rel="noopener noreferrer" target="_blank">
                    https://github.com/ThaiThiYenNhiBA/SSPS
                  </a>
                </li>
              </ul>
            </li>
            ...
            <li>
              ...
              <ul className="pl-6">
                ...
                <li>
                  <strong>Goal:</strong> Develop a real-time social media platform with interactive user features.
                </li>
                <li>
                  <strong>Role:</strong> Built core features including authentication, messaging, posting, commenting,
                  reactions, and friend management.
                </li>
                <li>
                  <strong>Technologies:</strong> Node.js, Express, WebSocket, MongoDB, LocalStorage.
                </li>
                <li>
                  <strong>Achievements:</strong>
                  <ul className="pl-6">
                    <li>
                      Delivered a functional and engaging platform with real-time messaging, file sharing, post
                      interactions, and social connectivity.
                    </li>
                  </ul>
                </li>
                <li>
                  <strong>Github:</strong> None
                </li>
              </ul>
            </li>
          </ul>
